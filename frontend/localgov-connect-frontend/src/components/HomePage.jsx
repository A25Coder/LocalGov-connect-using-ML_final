            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:items-start">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    {filteredIssues.map(issue => {
                        ...
                        return (
                            <div key={issue.id} className="bg-white p-4 rounded-xl shadow-md transition-shadow duration-300 hover:shadow-xl">
                                <div className="flex items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 mt-1">
                                            ...
                                            <span className={`text-xs font-bold px-2 py-1 rounded-full text-white ${issue.severity === "emergency" ? "bg-red-600" : issue.severity === "critical" ? "bg-orange-500" : issue.severity === "urgent" ? "bg-yellow-500" : "bg-blue-500"}`}>{issue.severity?.toUpperCase() || "NEEDS ATTENTION"}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-between items-center text-gray-500 text-sm border-t pt-3">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <Link to={`/dashboard/issue/${issue.id}`} className="flex items-center gap-1.5"><span>💬</span><span className="font-semibold">{issue.comments[0]?.count || 0}</span></Link>
                                    </div>
